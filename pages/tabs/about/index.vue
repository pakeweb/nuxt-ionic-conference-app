...
watch(location, (newLocation: string) => {
    ...
    <ion-content>
        ...
        <ion-toolbar>
          ...
          <ion-buttons slot="end">
            <ion-button id="popover-button">
              <ion-icon slot="icon-only" :icon="ioniconsEllipsisHorizontal" />
            </ion-button>
          </ion-buttons>
        </ion-toolbar>
      </ion-header>
      ...
      <div class="about-info">
        ...
        <p class="ion-padding-start ion-padding-end">
          ...
          {{ useDateFormat(conferenceDate, "MMM dd, yyyy") }}
        ...
        <ion-list lines="none">
          <ion-item>
            <ion-select v-model="location" label="Location" :interface-options="selectOptions">
              <ion-select-option value="madison">
                Madison, WI
              </ion-select-option>
              <ion-select-option value="austin">
                Austin, TX
              </ion-select-option>
              <ion-select-option value="chicago">
                Chicago, IL
              </ion-select-option>
              <ion-select-option value="seattle">
                Seattle, WA
              </ion-select-option>
            </ion-select>
          </ion-item>
          <ion-item id="open-date-input" :button="true">
            <ion-label>
              Date
            </ion-label>
            <ion-text slot="end">
            ...
            <ion-popover id="date-input-popover" trigger="open-date-input" :show-backdrop="false" side="top" alignment="end">
              <ion-datetime v-model="conferenceDate" max="2056" presentation="date" />
            </ion-popover>
          </ion-item>
        </ion-list>
        ...
        <ion-list lines="none">
          <ion-item>
            ...
            <ion-label class="ion-text-end">
              ica{{ useDateFormat(conferenceDate, "y") }}
            </ion-label>
          </ion-item>
          <ion-item>
            <ion-label>
